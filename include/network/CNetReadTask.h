#ifndef EASYGO_NETWORK_CNETREADTASK_H
#define EASYGO_NETWORK_CNETREADTASK_H
...
namespace easygo {
	namespace network {
		...
		class EASYGO_NETWORK_DECL CNetReadTask : public easygo::thread::CTask
		{
		public:
			CNetReadTask(PCSocket socket);
			virtual ~CNetReadTask();
...
#endif // EASYGO_NETWORK_CNETREADTASK_H
