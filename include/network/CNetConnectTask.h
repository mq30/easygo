#ifndef EASYGO_NETWORK_CNETCONNECTTASK_H
#define EASYGO_NETWORK_CNETCONNECTTASK_H
...
namespace easygo {
	namespace network {
		...
		class EASYGO_NETWORK_DECL CNetConnectTask : public easygo::thread::CTask
		{
		public:
			CNetConnectTask(PCSocket socket);
			virtual ~CNetConnectTask();
...
#endif // EASYGO_NETWORK_CNETCONNECTTASK_H
